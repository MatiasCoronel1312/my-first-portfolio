      ...
      <div className=" md:w-[75%] mx-auto ">
        ...
        <div id={2} className={`h-[100vh] w-full `}>
          <div className="flex justify-between w-[75%] ">
            <h1 className="text-[#016262] font-semibold py-10 text-3xl w-1/2">Contact me</h1>
            <div className=" w-1/2 flex flex-col  justify-end pl-28">
              <h2 className=" h-8 font-semibold text-xl text-[#016262] ">Write me:</h2>
              <div className="flex">
                <p className="font-semibold">5446matias@gmail.com</p>
                <button onClick={handleCopyClick} className="w-8"><img src={copy} alt="copy" /></button>
              </div>
          ...
          <div className="flex h-full">
            <div className="w-1/2 flex flex-col">
                  <a href="https://github.com/MatiasCoronel1312" target="_blank" className="flex border-4 border-black rounded-2xl px-3 py-1 justify-center w-[17rem] mb-12 hover:bg-[#016262]">
                    <img className="w-[25%]" src={githubMark} alt="github-logo" />
                    <img className="w-[50%]" src={github_Logo} alt="github" />
                    
                  </a>
                  <a href="https://www.linkedin.com/in/matias-coronel-77a8b822b/" target="_blank" className="border-4 border-black rounded-2xl w-[17rem] h-[5rem] flex items-center hover:bg-[#016262]">
          ...
          <div>
           <form className="rounded-lg flex flex-col justify-center " action="https://formsubmit.co/elmati.08@hotmail.com" method="POST">
              ...
              <div className="rounded-lg border-4 border-black mb-1">
                  <input className="rounded-lg p-1 w-full bg-[#BBDEF0]" type="text" name="nombre" placeholder="Nombre" required/>
              </div>
              <div className="rounded-lg border-4 border-black mb-1 ">
                  <input className="rounded-lg p-1 w-full bg-[#BBDEF0]" type="email" name="email" id="email" placeholder="Email" required/>
              </div>
              <div>
                  <textarea className="rounded-lg border-4 border-black p-1 h-[7rem] bg-[#BBDEF0]" name="consulta" placeholder="Ingrese texto" cols="30" rows="8"></textarea>
              </div>
              <div>
